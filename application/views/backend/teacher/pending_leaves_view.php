                ...
                <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                ...
                                <li>
                                    <a href="#" onclick="approve_modal('<?php echo base_url();?>index.php?teacher/accept_leave/<?php echo $row['id'];?>/<?php echo $class_id;?>/<?php echo $section_id;?>');">
                                    ...
                                    <a href="#" onclick="reject_modal('<?php echo base_url();?>index.php?teacher/reject_leave/<?php echo $row['id'];?>/<?php echo $class_id;?>/<?php echo $section_id;?>/');">
