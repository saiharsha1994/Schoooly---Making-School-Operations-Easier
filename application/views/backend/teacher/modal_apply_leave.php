    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
                <?php echo form_open(base_url().'index.php?teacher/leave_managment/create' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>

                    <div class="form-group">
                        <label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('from_date'); ?></label>

                        <div class="col-sm-5">
                            <input type="text" id="from_date" name="timestamp1" class="form-control datepicker" data-format="dd-mm-yyyy" 
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" id="to_date" name="timestamp2" class="form-control datepicker" data-format="dd-mm-yyyy" 
                                placeholder="<?php echo get_phrase('select_date');?>" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>">
                        </div>
                        <span></span>
                    </div>
                    ...
                    <div class="col-sm-3 control-label col-sm-offset-2">
                        <button type="submit" class="btn btn-success"><?php echo get_phrase('apply');?></button>
                    </div>
                </form>
