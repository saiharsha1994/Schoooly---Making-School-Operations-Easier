    ...
    <div class="box-content">
        ...
        <?php echo form_open(base_url(). 'index.php?admin/noticeboard/do_update/'.$row['notice_id'] , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
            <div class="padded">
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label"><?php echo get_phrase('recipient');?></label>
                    <div class="col-sm-5">
                        <select class="form-control" name="reciever">
                            <option value="teacher"<?=$row['reciever'] == 'teacher' ? ' selected="selected"' : '';?>><?php echo get_phrase('teacher');?></option>
                            <option value="parent"<?=$row['reciever'] == 'parent' ? ' selected="selected"' : '';?>><?php echo get_phrase('parent');?></option>
                        </select>
                    </div>
                </div>
				<div class="form-group">
