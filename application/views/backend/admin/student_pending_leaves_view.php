        ...
        $leavelist=$this->db->query("SELECT id,student_id,from_date,to_date,reason FROM leave_records WHERE student_id IN (SELECT student_id FROM student WHERE class_id='$class_id' AND section_id='$section_id') AND user_type=1 AND status=1")->result_array(); 

        ?> 
        <?php echo form_open(base_url() . 'index.php?admin/student_pending_leaves_view/');?>
    <form method="POST">
        <div class="row">
    ...
    <thead>
        <tr>
            ...
            <th class="col-md-5"><?php echo get_phrase('reason');?></th>
                ...
                <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                ...
                                <li>
                                    <a href="#" onclick="approve_modal('<?php echo base_url();?>index.php?admin/student_accept_leave/<?php echo $row['id'];?>/<?php echo $class_id;?>/<?php echo $section_id;?>');">
                                    ...
                                    <a href="#" onclick="reject_modal('<?php echo base_url();?>index.php?admin/student_reject_leave/<?php echo $row['id'];?>/<?php echo $class_id;?>/<?php echo $section_id;?>/');">
    ...
    $(document).ready(function(){
        ...
        $('#class_id').change(function () {
            ...
            if(classid==""){
                ...
                $.ajax({
                url: '<?php echo base_url();?>index.php?admin/section_data/' +classid ,
                async:false,
