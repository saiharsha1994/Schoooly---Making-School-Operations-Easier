               ...
               <table class="table table-bordered datatable" id="table_export">
                    <thead>
                        <tr>
                            ...
                            <th><div><?php echo get_phrase('temp_address');?></div></th>
                    ...
                    <tbody>
						...
						<div class="btn-group">
							...
							<ul class="dropdown-menu dropdown-default pull-right" role="menu">
								...
								<li>
									<a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php?admin/teacher_view/delete/<?php echo $row['teacher_id'];?>');">
