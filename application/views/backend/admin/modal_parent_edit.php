<?php		
	...
	foreach ($edit_data as $row):	
		$decrypt_val = $this->apicrypter->decrypt($row['password']);		
?>
			...
			<div class="panel-body">
                ...
                <?php echo form_open(base_url() . 'index.php?admin/parent/edit/' . $row['parent_id'] , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" name="password" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>" value="<?php echo $decrypt_val;?>">
						</div>
					</div>
