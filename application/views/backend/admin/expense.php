...
<table class="table table-bordered datatable" id="table_export">
    <thead>
        <tr>
			...
			<th><div><?php echo get_phrase('vendor');?></div></th>
    ...
    <tbody>
        ...
        <tr>
			...
			<td>
				<a href="#" onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/expense_invoice/<?php echo $row['exp_id'];?>');">
            ...
            <td>
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                        ...
                        <li>
                        	<a href="#" onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/expense_edit/<?php echo $row['exp_id'];?>');">
                        ...
                        <li>
                        	<a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php?admin/expense/delete/<?php echo $row['exp_id'];?>');">
