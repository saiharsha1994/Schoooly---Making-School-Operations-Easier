    ...
    <thead>
        <tr>
            ...
            <th><div><?php echo get_phrase('to_date');?></div></th>
                <th><div><?php echo get_phrase('executed_on');?></div></th>
                ...
                <?php if($row['status']=="2" ){?>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <li>
                                    <a href="#" onclick="confirm_modal3('<?php echo base_url();?>index.php?admin/approve_reject_by_ministry/approve/<?php echo $row['id'];?>');">
                                ...
                                <li>
                                    <a href="#" onclick="confirm_modal1('<?php echo base_url();?>index.php?admin/approve_reject_by_ministry/reject/<?php echo $row['id'];?>');">
                                        <i class="entypo-trash"></i>
