<?php 
$edit_data      =   $this->db->get_where('request_inventory' , array('id' => $param2) )->result_array();
	...
	<div class="col-md-12">
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
                ...
                <?php echo form_open(base_url() . 'index.php?admin/request_inventory_update' , array(
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <select name="inventory_id" class="form-control" style="width:100%;" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>">
                                ...
                                ?>
                                    <option value="<?php echo $row2['id'];?>" <?php if($row['inventory_id']==$row2['id']) echo 'selected';?> ><?php echo $row2['name'];?></option>
                                <?php
                                endforeach;
                                ?>
                            </select>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" name="requested_quantity"
                                data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>" value='<?php echo $row['requested_quantity'];?>'/>
                        </div>
                    </div>        
                    ...
                    <!-- <div class="form-group"> -->
                        ...
                        <div class="col-sm-6">
                            <select name="role" class="form-control" style="width:100%;" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>" onchange="return get_employees_roles(this.value)">
                                ...
                                foreach($hr as $row2):
                                ?>
                                    <option value="<?php echo $row2['id'];?>" <?php if($row2['id']==$x) echo 'selected';?> ><?php echo $row2['role'];?></option>
                                <?php
                                endforeach;
                                ?>
                            </select>
                        ...
                        <div class="col-sm-6">
                            ...
                            <option></option>
                                ...
                                $employees = $this->db->select('*')->from('employee_details')->where("emp_type LIKE '%$x%'")->get()->result_array();
                                foreach($employees as $row2):
                              ?>
                              <option value="<?php echo $row2['emp_id'];?>"
                                <?php if($y == $row2['emp_id']) echo 'selected';?>><?php echo $row2['name'];?></option>
                                <?php endforeach;?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" name="requested_for"
                                data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>" value='<?php echo $z;?>'/>
                        </div>
                    </div>       
