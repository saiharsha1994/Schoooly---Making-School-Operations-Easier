		...
		<label class="control-label" style="margin-bottom: 5px;"><?php echo get_phrase('exam');?></label>
			<select name="exam_id" class="form-control selectboxit" required>
				...
				<option value="<?php echo $row['_id'];?>"
					<?php if($exam_id == $row['_id']) echo 'selected';?>><?php echo $row['title'];?></option>
				<?php endforeach;?>
			</select>
		</div>
	</div>
...
<div class="row" style="text-align: center;">
	...
	<div class="col-sm-4">
		<div class="tile-stats tile-gray">
			...
			<h3 style="color: #696969;"><?php echo get_phrase('marks_for');?> <?php echo $this->db->get_where('exam_schedule' , array('_id' => $exam_id))->row()->title;?></h3>
			...
			<table class="table table-bordered">
				<thead>
					<tr>
						...
						<th class="col-md-1"><?php echo get_phrase('marks_obtained');?></th>
