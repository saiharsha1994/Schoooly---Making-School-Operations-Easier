...
function fill_table(){
    ...
    $.ajax({
        ...
        url : '<?php echo base_url();?>index.php?admin/get_approved_data/',
        dataType: "JSON",
...
function drawRow(rowData) {
    ...
    function showModalEdit(student_id){
        //alert(student_id)
        showAjaxModal('<?php echo base_url();?>index.php?modal/popup/modal_student_edit/'+student_id+'');
    }
...
function get_filter_student(class_id, section_id){
        ...
        var data;
            ...
            url = '<?php echo base_url();?>index.php?admin/get_approved_filter_data/';
