	...
	<div class="col-md-12">
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
                ...
                <?php echo form_open(base_url() . 'index.php?admin/expense/edit/' . $row['exp_id'] , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
					...
					<div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <select name="expense_category_id" class="form-control select2" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>">
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input type="text" class="form-control" name="amount" value="<?php echo $row['total_amount'];?>" 
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="datepicker form-control" name="exp_date"
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input type="text" class="form-control" name="invoice_number" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>" 
							value="<?php echo $row['invoice_number'];?>" >
						</div>
					</div>

					<div class="form-group">
						<label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('vendor_name');?></label>
                        
						<div class="col-sm-6">
							<input type="text" class="form-control" name="vendor_name" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>" 
