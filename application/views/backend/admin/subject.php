                ...
                <table class="table table-bordered datatable" id="table_export">
                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<td><?php echo $this->db->get_where('employee_details', array('emp_id' => $row['teacher_id']))->row()->name;?></td>
							<td>
                            <div class="btn-group">
                	...
                	<?php echo form_open(base_url() . 'index.php?admin/subject/create' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                        <div class="padded">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <select name="class_id"  class="form-control select2"  data-validate="required" data-message-required="<?php echo get_phrase('required');?>"  class="form-control selectboxit" style="width:100%;">
                                    	<?php 
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <select name="teacher_id" class="form-control select2" style="width:100%;"  data-validate="required" data-message-required="<?php echo get_phrase('required');?>">
