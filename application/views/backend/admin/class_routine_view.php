<hr />
<a href="<?php echo base_url();?>index.php?admin/class_routine_add/<?php echo $class_id; ?>"
                            ...
                            <td>
                                ...
                                <div class="btn-group">
                                    <button class="btn btn-default dropdown-toggle" data-toggle="dropdown">
                                        <?php echo $this->crud_model->get_teacher_name($this->db->get_where('subject' , array('subject_id' => $row2['subject_id']))->row()->teacher_id);?>
										<br/>
