...
<!------CONTROL TABS START------>
		<ul class="nav nav-tabs bordered">
			<li class="active">
            	<a href="#student" data-toggle="tab">
					...
					<?php echo get_phrase('add_child');?>
				</a>
			</li>
			<li>
				<a href="#document" data-toggle="tab">
					<i class="entypo-plus-circled"></i>
					<?php echo get_phrase('add_child_document');?>
				</a>
			</li>
		</ul>
    	<!------CONTROL TABS END------>
		...
		<div class="tab-pane box active" id="student">
          ...
          <?php echo form_open(base_url() . 'index.php?parents/student/create/', array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data', 'id' => 'form'));?>
    ...
    <div id="collapseThree" class="panel-collapse collapse">
      <div class="panel-body">
          <div class="form-group">
              ...
              <input type="hidden" class="form-control" name="childCount" value="<?php echo $row['child_count'];?>">
              <div class="form-group">
                <label for="field-1" class="col-sm-3 control-label">Parent Email</label>
                <div class="col-sm-5">
                  <input type="text" class="form-control" name="parentEmail" value="<?php echo $row['email'];?>">
                </div>
              </div>
<div class="form-group">
...
<div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control" name="fatherName" value="<?php echo $row['name'];?>">
                </div>
              </div>
<div class="form-group">
                <label for="field-1" class="col-sm-3 control-label">Father's Nationality</label>
                <div class="col-sm-5">
                  <input type="text" class="form-control" name="fatherNationality" value="<?php echo $row['father_nationality'];?>">
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control" name="fatherEmployer"  value="<?php echo $row['father_empr_sponsor_name'];?>">
                </div>
              </div>
              <!-- <div class="form-group">
...
<div class="form-group">
                ...
                <div class="col-sm-5">
                  <textarea class="form-control" rows="5" name="fatherWorkAddress" id="fatherWorkAddress" value="<?php echo $row['father_work_address'];?>"><?php echo $row['father_work_address'];?></textarea>
                </div>
              </div>
<div class="form-group">
                <label for="field-1" class="col-sm-3 control-label">Mother's Name</label>
                <div class="col-sm-5">
                  <input type="text" class="form-control" name="motherName" value="<?php echo $row['mother_name'];?>">
                </div>
              </div>
<div class="form-group">
                <label for="field-1" class="col-sm-3 control-label">Mother's Nationality</label>
                <div class="col-sm-5">
                  <input type="text" class="form-control" name="motherNationality" value="<?php echo $row['mother_nationality'];?>">
                </div>
              </div>
<div class="form-group">
                <label for="field-1" class="col-sm-3 control-label">Mother's Occupation</label>
                <div class="col-sm-5">
                  <input type="text" class="form-control" name="motherOccupation" value="<?php echo $row['mother_occupation'];?>">
                </div>
              </div>
<div class="form-group">
                <label for="field-1" class="col-sm-3 control-label">Mother's Employer</label>
                <div class="col-sm-5">
                  <input type="text" class="form-control" name="motherEmployer" value="<?php echo $row['mother_empr_sponsor_name'];?>">
                </div>
              </div>
              <!-- <div class="form-group">
...
<div class="form-group">
                ...
                <div class="col-sm-5">
                  <textarea class="form-control" rows="5" name="motherWorkAddress" id="motherWorkAddress">
                  	<?php echo $row['mother_work_address'];?>
                  </textarea>
                </div>
              </div>
      </div>
...
<?php echo form_close();?>   
    ...
    <div class="tab-pane box" id="document" style="padding: 5px">
          ...
          <?php echo form_open(base_url() . 'index.php?parents/student/add_document' , array(
              ...
              <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <select name="student_id" class="form-control selectboxit" style="width:100%;">
                                        <option value=""><?php echo get_phrase('select_child');?></option>
                                      <?php 
                    $students = $this->db->get_where('student', array('parent_id'=> $parent_id))->result_array();
